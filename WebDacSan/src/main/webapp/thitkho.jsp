...
<html lang="en">
  ...
  <body>
          ...
          <div class="nut-menu">
            ...
            <div class="menu-bar-content">
                <ul>
                    ...
                    <li><a href="gao.jsp">Gia vị tây bắc</a></li>
                    <li><a href="giavi.jsp">Gạo tây bắc</a></li>
    ...
    <section class="anhbia">
      <div class="phanloai">
        <h1 class="tenloai">Thịt Khô Gác Bếp</h1>
        <div class="menu-vao"><a style="text-decoration: none;color: rgba(102,102,102,0.7); " href="">Trang Chủ</a> <span class="gachcheo">/</span> Thịt Khô Gác Bếp</div>  
    </div>
    </section>
	    ...
	    <tbody>
	     <c:forEach var="sanpham" items="${danhsach}">
	      ...
	      <tr>
	       ...
	       <td><c:out value="${sanpham.loai}" /></td>
	       <td><c:out value="${sanpham.anh}" /></td>
	       <td><c:out value="${sanpham.moTa}" /></td>	      
			<td><a href="borrowform?id=<c:out value='${sanpham.maSP}' />">Thêm vào giỏ</a>
